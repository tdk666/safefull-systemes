        ...
        <div className="bg-deep-dark min-h-screen pb-24">
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8 pt-24 sm:pt-32">
                <div className="mx-auto max-w-3xl text-center mb-24">
                    <FadeIn direction="up">
                        <ShieldCheck className="mx-auto h-16 w-16 text-safefull-slate mb-6" />
                        <h2 className="text-sm font-bold tracking-widest text-safefull-slate uppercase">Qui Sommes-Nous ?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
                    <FadeIn delay={0.1} direction="up">
                        <div className="rounded-none border border-white/5 bg-dark-surface/50 p-8 h-full">
                            <History className="h-8 w-8 text-safefull-orange mb-6" />
                    ...
                    <FadeIn delay={0.2} direction="up">
                        <div className="rounded-none border border-white/5 bg-dark-surface/50 p-8 h-full">
                            <Target className="h-8 w-8 text-safefull-slate mb-6" />
                    ...
                    <FadeIn delay={0.3} direction="up">
                        <div className="rounded-none border border-white/5 bg-dark-surface/50 p-8 h-full">
                            <Users className="h-8 w-8 text-safefull-orange mb-6" />
