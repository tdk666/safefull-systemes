    ...
    return (
        <div className="flex flex-col min-h-screen bg-deep-dark">
            ...
            <section className="relative py-24 sm:py-32 border-t border-white/5 overflow-hidden">
                {/* Lueur d'ambiance */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-[500px] w-full max-w-4xl rounded-full bg-safefull-orange/5 blur-[120px] pointer-events-none"></div>
