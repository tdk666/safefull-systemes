                ...
                <div className="space-y-6">
                    <FadeIn delay={0.1} direction="up">
                        <section className="group relative rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent p-8 sm:p-10 shadow-glass backdrop-blur-xl transition-all duration-500 hover:border-safefull-slate/30 hover:bg-white/[0.05]">
                            <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4 tracking-tight">1. Données Collectées</h2>
                            <div className="space-y-4 text-gray-400 leading-relaxed">
                                ...
                                <ul className="list-none list-inside mt-2 space-y-2">
                                    <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-safefull-orange"></div> Nom de votre entreprise</li>
                                    <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-safefull-orange"></div> Nom du contact principal</li>
                                    <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-safefull-orange"></div> Adresse email professionnelle</li>
                                    <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-safefull-orange"></div> Secteur d'activité</li>
                                    <li className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-safefull-orange"></div> Contenu de votre demande</li>
                                </ul>
                            </div>
                        </section>
                    </FadeIn>
                    ...
                    <FadeIn delay={0.2} direction="up">
                        <section className="group relative rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent p-8 sm:p-10 shadow-glass backdrop-blur-xl transition-all duration-500 hover:border-safefull-slate/30 hover:bg-white/[0.05]">
                            <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4 tracking-tight">2. Finalité du Traitement</h2>
                            <div className="space-y-4 text-gray-400 leading-relaxed">
                                <p>
                    ...
                    <FadeIn delay={0.3} direction="up">
                        <section className="group relative rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent p-8 sm:p-10 shadow-glass backdrop-blur-xl transition-all duration-500 hover:border-safefull-slate/30 hover:bg-white/[0.05]">
                            <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4 tracking-tight">3. Sécurité</h2>
                            <div className="space-y-4 text-gray-400 leading-relaxed">
                                <p>
                    ...
                    <FadeIn delay={0.4} direction="up">
                        <section className="group relative rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent p-8 sm:p-10 shadow-glass backdrop-blur-xl transition-all duration-500 hover:border-safefull-orange/30 hover:bg-white/[0.05]">
                            <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4 tracking-tight">4. Droit d'Accès et de Rectification</h2>
                            <div className="space-y-4 text-gray-400 leading-relaxed">
                                <p>
                                ...
                                <div className="mt-6 p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                                    ...
                                    <p>Contact : <a href="mailto:marc.dequecker@safefull.com" className="text-white hover:text-safefull-slate transition-colors underline decoration-white/30 underline-offset-4">marc.dequecker@safefull.com</a></p>
                                </div>
                            </div>
                        </section>
                    </FadeIn>
