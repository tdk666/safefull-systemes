    ...
    const features = [
        {
            ...
            icon: Smartphone,
            color: "text-safefull-orange",
            borderColor: "group-hover:border-safefull-orange/50"
        },
        {
            ...
            icon: MapPin,
            color: "text-safefull-slate",
            borderColor: "group-hover:border-safefull-slate/50"
        },
        {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <FadeIn key={feature.title} delay={0.1 + index * 0.1} direction="up" className="h-full">
                                <div className={`group relative h-full flex flex-col rounded-xl border border-white/5 bg-gradient-to-b from-white/[0.03] to-transparent p-8 shadow-glass backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.05] hover:shadow-orange-glow ${feature.borderColor}`}>
                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-safefull-orange/30 bg-glass-gradient p-12 text-center shadow-orange-glow backdrop-blur-2xl group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="pt-8 border-t border-white/10 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
                                ...
                                <a href="/downloads/mobeeweb-synthese.pdf" target="_blank" rel="noreferrer" className="hover:text-safefull-orange transition-colors flex items-center gap-1">Fiche PDF <ArrowRight className="h-3 w-3" /></a>
                                <a href="/downloads/mobeeweb-isafe.ppt" className="hover:text-safefull-orange transition-colors flex items-center gap-1">Slides PPT <ArrowRight className="h-3 w-3" /></a>
                                <a href="/downloads/Vignette1_MobeeWeb.pptx" className="hover:text-safefull-orange transition-colors flex items-center gap-1">Vignette 1 <ArrowRight className="h-3 w-3" /></a>
                                <a href="/downloads/Vignette2_MobeeWeb.pptx" className="hover:text-safefull-orange transition-colors flex items-center gap-1">Vignette 2 <ArrowRight className="h-3 w-3" /></a>
                            </div>
                        </div>
                    </div>
                </FadeIn>
