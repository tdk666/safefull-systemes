                    ...
                    <div className="relative overflow-hidden rounded-2xl border border-safefull-slate/30 bg-glass-gradient p-12 text-center shadow-glass backdrop-blur-2xl group">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="pt-8 border-t border-white/10 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
                                ...
                                <a href="/downloads/nephrocall-presentation.pptx" className="hover:text-safefull-slate transition-colors flex items-center gap-1">Présentation PPTX <ArrowRight className="h-3 w-3" /></a>
                                <a href="/downloads/Vignette1_NephroCall.pptx" className="hover:text-safefull-slate transition-colors flex items-center gap-1">Vignette 1 <ArrowRight className="h-3 w-3" /></a>
                                <a href="/downloads/Vignette2_NephroCall.pptx" className="hover:text-safefull-slate transition-colors flex items-center gap-1">Vignette 2 <ArrowRight className="h-3 w-3" /></a>
                            </div>
                        </div>
                    </div>
                </FadeIn>
